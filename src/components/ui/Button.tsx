...
export function Button({
  ...
  return (
    <button
      className={cn(
        "inline-flex items-center justify-center rounded-lg border font-semibold transition-all focus:outline-none focus:ring-2 focus:ring-[#D7263D]/50 disabled:opacity-50 disabled:cursor-not-allowed",
