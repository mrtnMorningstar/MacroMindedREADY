...
export default function GlobalCancelPage() {
  return (
    <div className="relative isolate min-h-[calc(100vh-5rem)] bg-background text-foreground">
      ...
      >
        <div className="absolute -top-32 left-1/2 h-[620px] w-[620px] -translate-x-1/2 rounded-full bg-accent/25 blur-3xl" />
      ...
      <section className="relative mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-4xl flex-col items-center justify-center gap-10 px-6 text-center">
        ...
        >
          No charges were made. When you&apos;re ready to continue, revisit the
          dashboard or explore the packages again.
        </motion.p>
        ...
        >
          <Link
            href="/dashboard"
            className="rounded-full border border-foreground/40 px-6 py-3 text-xs font-semibold uppercase tracking-[0.32em] text-foreground transition hover:border-accent hover:text-accent"
          >
            Return to Dashboard
          </Link>
        </motion.div>
